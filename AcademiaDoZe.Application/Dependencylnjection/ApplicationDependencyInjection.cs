        ...
        public static IServiceCollection RegisterApplicationServices(this IServiceCollection services)
        {
            ...
            services.AddTransient(provider =>
            {
                ...
                return (Func<ILogradouroRepository>)(() => 
                    new LogradouroRepository(config.ConnectionString, (DatabaseType)config.DatabaseType));
            });

            services.AddTransient(provider =>
            {
                var config = provider.GetRequiredService<RepositoryConfig>();
                return (Func<IPlanoRepository>)(() => 
                    new PlanoRepository(config.ConnectionString, (DatabaseType)config.DatabaseType));
            });
            ...
            services.AddTransient(provider =>
            {
                ...
                return (Func<IColaboradorRepository>)(() => 
                    new ColaboradorRepository(config.ConnectionString, (DatabaseType)config.DatabaseType));
            });
            ...
            services.AddTransient(provider =>
            {
                ...
                return (Func<IAlunoRepository>)(() => 
                    new AlunoRepository(config.ConnectionString, (DatabaseType)config.DatabaseType));
            });
            ...
            services.AddTransient(provider =>
            {
                ...
                return (Func<IMatriculaRepository>)(() => 
                    new MatriculaRepository(config.ConnectionString, (DatabaseType)config.DatabaseType));
            });
