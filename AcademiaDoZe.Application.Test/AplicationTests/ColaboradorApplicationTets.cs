...
namespace AcademiaDoZe._Application.Tests.AplicationTests
{
    public class ColaboradorApplicationTests
    {
        ...
        public async Task ColaboradorService_Integracao_Adicionar_Obter_Atualizar_Remover()
        {
            ...
            var caminhoFoto = Path.Combine("C:\\Users\\coelho\\OneDrive\\Documentos\\Trabalhos\\Trabalhos Desenv Sistemas 2\\AcademiaDoZe\\AcademiaDoZe. Application.Tests\\AplicationTests\\foto_teste.png");
            ArquivoDTO foto = new();
